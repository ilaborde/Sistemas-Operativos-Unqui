...
class diskFactory:
    ...
    def configurationOfTheDiskWithThreePrograms(self):
        ...
        program2.add(Instruction("io Instructio3", InstructionType.cpu, ResourceType.Printer))
        program2.add(Instruction("io Instructio4", InstructionType.cpu, ResourceType.Printer))
        program2.add(Instruction("io Instructio5", InstructionType.cpu, ResourceType.Printer))
        program2.add(Instruction("io Instructio6", InstructionType.cpu, ResourceType.Printer))
        program2.add(Instruction("io Instructio7", InstructionType.cpu, ResourceType.Printer))
        program2.add(Instruction("io Instructio8", InstructionType.cpu, ResourceType.Printer))
        program2.add(Instruction("Kill Instruction", InstructionType.kill, ResourceType.Monitor))
